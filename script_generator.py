...
stain_strength_scale = float(sys.argv[6])
stain_density_scale = float(sys.argv[7])
...
for i in range(output_num):
    ...
    for stain_folder in stain_paths_list:
        ...
        strength_e.text = "{:.2f}".format(stain_strength_scale*random.random())
        density_e = etree.SubElement(gradient_degradation_e, "density")
        density_e.text = "{:.2f}".format(stain_density_scale*random.random())
